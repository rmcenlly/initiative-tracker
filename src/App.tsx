  ...
  return (
    <div className="mx-5">
                ...
                >
                  ...
                  <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                    <div className="block inline-flex">
                      {character.HP}
                      <svg xmlns="http://www.w3.org/2000/svg" className="self-center ml-1" width="24" height="24" viewBox="0 0 24 24">
                        <path fill="#eb1c45" d="M12 4.419c-2.826-5.695-11.999-4.064-11.999 3.27 0 7.27 9.903 10.938 11.999 15.311 2.096-4.373 12-8.041 12-15.311 0-7.327-9.17-8.972-12-3.27z" />
                      </svg>
                    </div>
                    <input
                  ...
                  <td className="p-2 md:border md:border-grey-500 text-left block md:table-cell">
                    <div className="block inline-flex">
                      {character.AC}
                      <svg xmlns="http://www.w3.org/2000/svg" className="self-center ml-1" version="1.0" width="24" height="24" viewBox="0 0 1024.000000 1280.000000" preserveAspectRatio="xMidYMid meet">
                        <metadata>
                          Created by potrace 1.15, written by Peter Selinger 2001-2017
                        </metadata>
                        <g transform="translate(0.000000,1280.000000) scale(0.100000,-0.100000)" fill="#dba135" stroke="#dba135#c5e0df">
      ...
      <div className="flex justify-center mb-5">
        ...
        <button
          className="w-36 border-double border-4 border-amber-500 mx-2 my-2 bg-zinc-900 transition duration-150 ease-in-out hover:bg-gray-400 rounded text-amber-500 px-0 py-2 focus:outline-none focus:ring-offset-2  focus:ring-amber-500 font-bold"
          onClick={() => {
